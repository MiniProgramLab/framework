...
function expectValue(actual, expected, field, filename) {
  if (actual !== expected)
    throw new Error(
      '纯 Skyline 要求 ' +
        field +
...
export function validateSkylineApp(config, filename) {
...
/** 拒绝本地配置切换渲染器或组件框架。 */
export function validateSkylineRenderer(config, filename) {
...
export function withSkylinePage(config, filename) {
...
export function validateSkylineProject(config, filename) {
  expectValue(
